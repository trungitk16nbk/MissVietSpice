    ...
    $(document).ready(function() {
      ...
      var updateWishlist = function (self) {
        ...
        if (isRemove) {
          ...
          if(icon_length != 0 && attr != 'product'){
            $wishlistButton.html('<span class="add-wishlist"><i class="fa fa-heart"></i></span><span class="loading-wishlist ajax-loader"><span class="spinner-border"></span></span><span class="remove-wishlist"><i class="ion-androi  "></i></span>');
          }
        ...
        /* Add */ 
          ...
          ///alert(icon_length);
          if(icon_length != 0 && attr != 'product'){
            $wishlistButton.html('<span class="add-wishlist"><i class="fa fa-heart"></i></span><span class="loading-wishlist ajax-loader"><span class="spinner-border"></span></span><span class="remove-wishlist"><i class="ion-android-close"></i></span>');
          }
          var wishlist_count_value = localStorage.getItem('user_wishlist_count');
          $wishlitcounter.html(wishlist_count_value);
        }
        ...
        $wishlistButton.each(function () {
          ...
          if (wishlist.indexOf(productHandle) > -1) {
            ...
            if($(this).hasClass('is-active')){
              if(icon_length != 0 && attr != 'product'){
                $(this).html('<span class="add-wishlist"><i class="fa fa-heart"></i></span><span class="loading-wishlist ajax-loader"><span class="spinner-border"></span></span><span class="remove-wishlist"><i class="ion-android-close"></i></span>');
              }
            }else{
              if(icon_length != 0 && attr != 'product'){
                $(this).html('<span class="add-wishlist"><i class="fa fa-heart"></i></span><span class="loading-wishlist ajax-loader"><span class="spinner-border"></span></span><span class="remove-wishlist"><i class="ion-android-close"></i></span>');
      ...
      */   
      ...
      $(".action-wishlist").on('click', function() {
        ...
        setTimeout(function () {
          $(".action-wishlist").removeClass("loading-wishlist ajax-loader");
        },1000);
        setTimeout(function () {
